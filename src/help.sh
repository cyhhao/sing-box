show_help() {
    ...
    *)
        ...
        help_info=(
            ...
            "   url [name]                                      URL 信息"
            "   log                                             查看日志"
            "HTTPS Proxy (标准 HTTPS 代理, ACME + Cloudflare DNS-01):"
            "   https-proxy add [port] [domain] [user] [pass] [email]  添加 HTTPS Proxy"
            "   https-proxy del <port|tag>                      删除 HTTPS Proxy"
            "   https-proxy info [port|tag]                     查看 HTTPS Proxy 信息"
            "   https-proxy list                                列出所有 HTTPS Proxy"
            # "   logerr                                          查看错误日志\n"
            "更改:"
